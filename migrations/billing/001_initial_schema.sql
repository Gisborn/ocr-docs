...
DROP TRIGGER IF EXISTS set_request_id ON billing_events;

DROP FUNCTION IF EXISTS update_updated_at_column();
DROP FUNCTION IF EXISTS generate_billing_event_uuid();
...
DROP TABLE IF EXISTS tariff_service_prices CASCADE;
...
DROP TYPE IF EXISTS billing_event_type;
